...
export const SponsoredProgramCreateInputSchema: z.ZodType<Prisma.SponsoredProgramCreateInput> = z.strictObject({
...
export default SponsoredProgramCreateInputSchema;
