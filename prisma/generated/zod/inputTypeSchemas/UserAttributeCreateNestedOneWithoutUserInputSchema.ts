...
export const UserAttributeCreateNestedOneWithoutUserInputSchema: z.ZodType<Prisma.UserAttributeCreateNestedOneWithoutUserInput> = z.strictObject({
...
export default UserAttributeCreateNestedOneWithoutUserInputSchema;
