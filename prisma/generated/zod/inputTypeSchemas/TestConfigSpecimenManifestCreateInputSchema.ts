...
import { TestCatalogConfigurationCreateNestedOneWithoutSpecimenManifestEntriesInputSchema } from './TestCatalogConfigurationCreateNestedOneWithoutSpecimenManifestEntriesInputSchema';
import { TestCatalogVersionSpecimenCreateNestedOneWithoutVariantManifestsInputSchema } from './TestCatalogVersionSpecimenCreateNestedOneWithoutVariantManifestsInputSchema';

export const TestConfigSpecimenManifestCreateInputSchema: z.ZodType<Prisma.TestConfigSpecimenManifestCreateInput> = z.strictObject({
  ...
  configuration: z.lazy(() => TestCatalogConfigurationCreateNestedOneWithoutSpecimenManifestEntriesInputSchema),
  versionSpecimen: z.lazy(() => TestCatalogVersionSpecimenCreateNestedOneWithoutVariantManifestsInputSchema),
});

export default TestConfigSpecimenManifestCreateInputSchema;
