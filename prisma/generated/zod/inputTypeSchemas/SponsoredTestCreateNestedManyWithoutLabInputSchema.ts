...
export const SponsoredTestCreateNestedManyWithoutLabInputSchema: z.ZodType<Prisma.SponsoredTestCreateNestedManyWithoutLabInput> = z.strictObject({
...
export default SponsoredTestCreateNestedManyWithoutLabInputSchema;
