...
export const TestCatalogAuditLogWhereUniqueInputSchema: z.ZodType<Prisma.TestCatalogAuditLogWhereUniqueInput> = z.object({
  id: z.string(),
})
.and(z.strictObject({
...
export default TestCatalogAuditLogWhereUniqueInputSchema;
