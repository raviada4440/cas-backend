...
export const LabOrderCreateManyPatientInputSchema: z.ZodType<Prisma.LabOrderCreateManyPatientInput> = z.strictObject({
...
export default LabOrderCreateManyPatientInputSchema;
