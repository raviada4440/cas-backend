...
export const LabOrderConsentCountOrderByAggregateInputSchema: z.ZodType<Prisma.LabOrderConsentCountOrderByAggregateInput> = z.strictObject({
...
export default LabOrderConsentCountOrderByAggregateInputSchema;
