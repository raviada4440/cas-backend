...
import { TestCatalogVersionUpdateOneRequiredWithoutSpecimensNestedInputSchema } from './TestCatalogVersionUpdateOneRequiredWithoutSpecimensNestedInputSchema';
import { TestConfigSpecimenManifestUpdateManyWithoutVersionSpecimenNestedInputSchema } from './TestConfigSpecimenManifestUpdateManyWithoutVersionSpecimenNestedInputSchema';

export const TestCatalogVersionSpecimenUpdateInputSchema: z.ZodType<Prisma.TestCatalogVersionSpecimenUpdateInput> = z.strictObject({
  ...
  version: z.lazy(() => TestCatalogVersionUpdateOneRequiredWithoutSpecimensNestedInputSchema).optional(),
  variantManifests: z.lazy(() => TestConfigSpecimenManifestUpdateManyWithoutVersionSpecimenNestedInputSchema).optional(),
});

export default TestCatalogVersionSpecimenUpdateInputSchema;
