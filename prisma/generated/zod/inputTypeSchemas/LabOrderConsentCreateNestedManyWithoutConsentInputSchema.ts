...
export const LabOrderConsentCreateNestedManyWithoutConsentInputSchema: z.ZodType<Prisma.LabOrderConsentCreateNestedManyWithoutConsentInput> = z.strictObject({
...
export default LabOrderConsentCreateNestedManyWithoutConsentInputSchema;
