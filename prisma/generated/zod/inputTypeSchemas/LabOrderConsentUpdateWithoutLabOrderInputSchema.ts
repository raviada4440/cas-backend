...
export const LabOrderConsentUpdateWithoutLabOrderInputSchema: z.ZodType<Prisma.LabOrderConsentUpdateWithoutLabOrderInput> = z.strictObject({
...
export default LabOrderConsentUpdateWithoutLabOrderInputSchema;
