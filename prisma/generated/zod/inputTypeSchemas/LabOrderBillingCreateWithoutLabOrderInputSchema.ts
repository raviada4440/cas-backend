...
export const LabOrderBillingCreateWithoutLabOrderInputSchema: z.ZodType<Prisma.LabOrderBillingCreateWithoutLabOrderInput> = z.strictObject({
...
export default LabOrderBillingCreateWithoutLabOrderInputSchema;
