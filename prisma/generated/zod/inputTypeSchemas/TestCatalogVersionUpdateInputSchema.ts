...
export const TestCatalogVersionUpdateInputSchema: z.ZodType<Prisma.TestCatalogVersionUpdateInput> = z.strictObject({
...
export default TestCatalogVersionUpdateInputSchema;
