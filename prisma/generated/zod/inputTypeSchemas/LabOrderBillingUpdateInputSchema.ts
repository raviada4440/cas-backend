...
import { LabOrderUpdateOneWithoutLabOrderBillingNestedInputSchema } from './LabOrderUpdateOneWithoutLabOrderBillingNestedInputSchema';

export const LabOrderBillingUpdateInputSchema: z.ZodType<Prisma.LabOrderBillingUpdateInput> = z.strictObject({
...
export default LabOrderBillingUpdateInputSchema;
