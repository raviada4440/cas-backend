...
export const LabOrderBillingCountOrderByAggregateInputSchema: z.ZodType<Prisma.LabOrderBillingCountOrderByAggregateInput> = z.strictObject({
...
export default LabOrderBillingCountOrderByAggregateInputSchema;
