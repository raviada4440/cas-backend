...
export const LabOrderMaxOrderByAggregateInputSchema: z.ZodType<Prisma.LabOrderMaxOrderByAggregateInput> = z.strictObject({
...
export default LabOrderMaxOrderByAggregateInputSchema;
