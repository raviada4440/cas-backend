...
export const LabOrderSpecimenMinOrderByAggregateInputSchema: z.ZodType<Prisma.LabOrderSpecimenMinOrderByAggregateInput> = z.strictObject({
...
export default LabOrderSpecimenMinOrderByAggregateInputSchema;
