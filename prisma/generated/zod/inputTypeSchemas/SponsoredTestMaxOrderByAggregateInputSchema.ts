...
export const SponsoredTestMaxOrderByAggregateInputSchema: z.ZodType<Prisma.SponsoredTestMaxOrderByAggregateInput> = z.strictObject({
...
export default SponsoredTestMaxOrderByAggregateInputSchema;
