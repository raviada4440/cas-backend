...
import { LabOrderCreateNestedOneWithoutLabOrderBillingInputSchema } from './LabOrderCreateNestedOneWithoutLabOrderBillingInputSchema';

export const LabOrderBillingCreateInputSchema: z.ZodType<Prisma.LabOrderBillingCreateInput> = z.strictObject({
...
export default LabOrderBillingCreateInputSchema;
