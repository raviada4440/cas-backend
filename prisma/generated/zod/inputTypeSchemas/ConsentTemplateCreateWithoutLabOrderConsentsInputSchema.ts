...
import { ConsentAuditLogCreateNestedManyWithoutConsentTemplateInputSchema } from './ConsentAuditLogCreateNestedManyWithoutConsentTemplateInputSchema';

export const ConsentTemplateCreateWithoutLabOrderConsentsInputSchema: z.ZodType<Prisma.ConsentTemplateCreateWithoutLabOrderConsentsInput> = z.strictObject({
  ...
  auditLogs: z.lazy(() => ConsentAuditLogCreateNestedManyWithoutConsentTemplateInputSchema).optional(),
});

export default ConsentTemplateCreateWithoutLabOrderConsentsInputSchema;
