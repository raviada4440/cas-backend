...
export const LabOrderCreateNestedManyWithoutPatientInputSchema: z.ZodType<Prisma.LabOrderCreateNestedManyWithoutPatientInput> = z.strictObject({
...
export default LabOrderCreateNestedManyWithoutPatientInputSchema;
