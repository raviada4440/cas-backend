...
import { z } from 'zod';
import { TestCatalogVersionOrderLoincUncheckedCreateNestedManyWithoutLoincInputSchema } from './TestCatalogVersionOrderLoincUncheckedCreateNestedManyWithoutLoincInputSchema';
...
export const LoincUncheckedCreateWithoutConfigResultLoincsInputSchema: z.ZodType<Prisma.LoincUncheckedCreateWithoutConfigResultLoincsInput> = z.strictObject({
  loincNum: z.string(),
  ...
  testOrderLoincs: z.lazy(() => TestCatalogVersionOrderLoincUncheckedCreateNestedManyWithoutLoincInputSchema).optional(),
...
export default LoincUncheckedCreateWithoutConfigResultLoincsInputSchema;
