...
export const LabOrderSpecimenWhereInputSchema: z.ZodType<Prisma.LabOrderSpecimenWhereInput> = z.strictObject({
...
export default LabOrderSpecimenWhereInputSchema;
