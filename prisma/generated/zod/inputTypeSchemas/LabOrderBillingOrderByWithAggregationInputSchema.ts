...
import { LabOrderBillingCountOrderByAggregateInputSchema } from './LabOrderBillingCountOrderByAggregateInputSchema';
import { LabOrderBillingAvgOrderByAggregateInputSchema } from './LabOrderBillingAvgOrderByAggregateInputSchema';
import { LabOrderBillingMaxOrderByAggregateInputSchema } from './LabOrderBillingMaxOrderByAggregateInputSchema';
import { LabOrderBillingMinOrderByAggregateInputSchema } from './LabOrderBillingMinOrderByAggregateInputSchema';
import { LabOrderBillingSumOrderByAggregateInputSchema } from './LabOrderBillingSumOrderByAggregateInputSchema';

export const LabOrderBillingOrderByWithAggregationInputSchema: z.ZodType<Prisma.LabOrderBillingOrderByWithAggregationInput> = z.strictObject({
  ...
  _avg: z.lazy(() => LabOrderBillingAvgOrderByAggregateInputSchema).optional(),
  ...
  _sum: z.lazy(() => LabOrderBillingSumOrderByAggregateInputSchema).optional(),
});

export default LabOrderBillingOrderByWithAggregationInputSchema;
