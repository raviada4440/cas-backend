...
export const LabOrderFormWhereUniqueInputSchema: z.ZodType<Prisma.LabOrderFormWhereUniqueInput> = z.object({
  id: z.string(),
})
.and(z.strictObject({
...
export default LabOrderFormWhereUniqueInputSchema;
