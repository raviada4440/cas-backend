...
export const LabOrderConsentScalarWhereInputSchema: z.ZodType<Prisma.LabOrderConsentScalarWhereInput> = z.strictObject({
  AND: z.union([ z.lazy(() => LabOrderConsentScalarWhereInputSchema), z.lazy(() => LabOrderConsentScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => LabOrderConsentScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => LabOrderConsentScalarWhereInputSchema), z.lazy(() => LabOrderConsentScalarWhereInputSchema).array() ]).optional(),
...
export default LabOrderConsentScalarWhereInputSchema;
