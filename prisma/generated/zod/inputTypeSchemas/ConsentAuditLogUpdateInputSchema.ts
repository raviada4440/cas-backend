...
export const ConsentAuditLogUpdateInputSchema: z.ZodType<Prisma.ConsentAuditLogUpdateInput> = z.strictObject({
...
export default ConsentAuditLogUpdateInputSchema;
