...
import { UserIdentityUncheckedUpdateManyWithoutUserNestedInputSchema } from './UserIdentityUncheckedUpdateManyWithoutUserNestedInputSchema';
...
export const UserUncheckedUpdateWithoutUserAttributeInputSchema: z.ZodType<Prisma.UserUncheckedUpdateWithoutUserAttributeInput> = z.strictObject({
  ...
  userIdentities: z.lazy(() => UserIdentityUncheckedUpdateManyWithoutUserNestedInputSchema).optional(),
  userRoles: z.lazy(() => UserRoleUncheckedUpdateManyWithoutUserNestedInputSchema).optional(),
});

export default UserUncheckedUpdateWithoutUserAttributeInputSchema;
