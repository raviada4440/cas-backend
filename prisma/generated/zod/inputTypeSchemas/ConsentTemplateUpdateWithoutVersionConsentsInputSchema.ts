...
import { LabOrderConsentUpdateManyWithoutConsentTemplateNestedInputSchema } from './LabOrderConsentUpdateManyWithoutConsentTemplateNestedInputSchema';
...
export const ConsentTemplateUpdateWithoutVersionConsentsInputSchema: z.ZodType<Prisma.ConsentTemplateUpdateWithoutVersionConsentsInput> = z.strictObject({
  ...
  labOrderConsents: z.lazy(() => LabOrderConsentUpdateManyWithoutConsentTemplateNestedInputSchema).optional(),
  auditLogs: z.lazy(() => ConsentAuditLogUpdateManyWithoutConsentTemplateNestedInputSchema).optional(),
});

export default ConsentTemplateUpdateWithoutVersionConsentsInputSchema;
