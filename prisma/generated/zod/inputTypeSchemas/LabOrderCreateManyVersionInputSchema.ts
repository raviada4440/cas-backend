...
export const LabOrderCreateManyVersionInputSchema: z.ZodType<Prisma.LabOrderCreateManyVersionInput> = z.strictObject({
...
export default LabOrderCreateManyVersionInputSchema;
