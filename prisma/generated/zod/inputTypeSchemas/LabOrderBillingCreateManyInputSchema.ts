...
export const LabOrderBillingCreateManyInputSchema: z.ZodType<Prisma.LabOrderBillingCreateManyInput> = z.strictObject({
...
export default LabOrderBillingCreateManyInputSchema;
