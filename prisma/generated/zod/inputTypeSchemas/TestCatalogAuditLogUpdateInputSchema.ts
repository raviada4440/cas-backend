...
import { TestCatalogUpdateOneRequiredWithoutAuditLogsNestedInputSchema } from './TestCatalogUpdateOneRequiredWithoutAuditLogsNestedInputSchema';

export const TestCatalogAuditLogUpdateInputSchema: z.ZodType<Prisma.TestCatalogAuditLogUpdateInput> = z.strictObject({
  ...
  test: z.lazy(() => TestCatalogUpdateOneRequiredWithoutAuditLogsNestedInputSchema).optional(),
});

export default TestCatalogAuditLogUpdateInputSchema;
