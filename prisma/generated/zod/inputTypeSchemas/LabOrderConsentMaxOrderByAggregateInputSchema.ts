...
export const LabOrderConsentMaxOrderByAggregateInputSchema: z.ZodType<Prisma.LabOrderConsentMaxOrderByAggregateInput> = z.strictObject({
...
export default LabOrderConsentMaxOrderByAggregateInputSchema;
