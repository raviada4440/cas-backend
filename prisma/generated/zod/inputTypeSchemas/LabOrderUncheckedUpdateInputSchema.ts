...
export const LabOrderUncheckedUpdateInputSchema: z.ZodType<Prisma.LabOrderUncheckedUpdateInput> = z.strictObject({
...
export default LabOrderUncheckedUpdateInputSchema;
