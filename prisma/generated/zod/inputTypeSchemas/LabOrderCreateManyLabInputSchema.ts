...
export const LabOrderCreateManyLabInputSchema: z.ZodType<Prisma.LabOrderCreateManyLabInput> = z.strictObject({
...
export default LabOrderCreateManyLabInputSchema;
