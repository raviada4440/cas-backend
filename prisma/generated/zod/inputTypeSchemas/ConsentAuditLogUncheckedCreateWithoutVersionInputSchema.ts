...
export const ConsentAuditLogUncheckedCreateWithoutVersionInputSchema: z.ZodType<Prisma.ConsentAuditLogUncheckedCreateWithoutVersionInput> = z.strictObject({
...
export default ConsentAuditLogUncheckedCreateWithoutVersionInputSchema;
