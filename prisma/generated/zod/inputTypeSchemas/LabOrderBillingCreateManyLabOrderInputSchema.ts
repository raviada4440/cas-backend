...
export const LabOrderBillingCreateManyLabOrderInputSchema: z.ZodType<Prisma.LabOrderBillingCreateManyLabOrderInput> = z.strictObject({
...
export default LabOrderBillingCreateManyLabOrderInputSchema;
