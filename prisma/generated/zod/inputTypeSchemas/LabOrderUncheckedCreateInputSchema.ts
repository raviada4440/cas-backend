...
export const LabOrderUncheckedCreateInputSchema: z.ZodType<Prisma.LabOrderUncheckedCreateInput> = z.strictObject({
...
export default LabOrderUncheckedCreateInputSchema;
