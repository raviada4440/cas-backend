...
export const LabOrderCreateNestedManyWithoutLabInputSchema: z.ZodType<Prisma.LabOrderCreateNestedManyWithoutLabInput> = z.strictObject({
...
export default LabOrderCreateNestedManyWithoutLabInputSchema;
