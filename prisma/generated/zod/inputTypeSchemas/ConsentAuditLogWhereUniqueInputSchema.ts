...
export const ConsentAuditLogWhereUniqueInputSchema: z.ZodType<Prisma.ConsentAuditLogWhereUniqueInput> = z.object({
  id: z.string(),
})
.and(z.strictObject({
...
export default ConsentAuditLogWhereUniqueInputSchema;
