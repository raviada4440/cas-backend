...
export const TestCatalogAuditLogScalarWhereInputSchema: z.ZodType<Prisma.TestCatalogAuditLogScalarWhereInput> = z.strictObject({
  AND: z.union([ z.lazy(() => TestCatalogAuditLogScalarWhereInputSchema), z.lazy(() => TestCatalogAuditLogScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => TestCatalogAuditLogScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => TestCatalogAuditLogScalarWhereInputSchema), z.lazy(() => TestCatalogAuditLogScalarWhereInputSchema).array() ]).optional(),
...
export default TestCatalogAuditLogScalarWhereInputSchema;
