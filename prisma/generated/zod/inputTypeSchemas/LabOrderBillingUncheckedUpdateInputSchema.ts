...
export const LabOrderBillingUncheckedUpdateInputSchema: z.ZodType<Prisma.LabOrderBillingUncheckedUpdateInput> = z.strictObject({
...
export default LabOrderBillingUncheckedUpdateInputSchema;
