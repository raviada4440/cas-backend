...
export const LabOrderSpecimenUncheckedUpdateInputSchema: z.ZodType<Prisma.LabOrderSpecimenUncheckedUpdateInput> = z.strictObject({
...
export default LabOrderSpecimenUncheckedUpdateInputSchema;
