...
import { z } from 'zod';
import { LabOrderUncheckedCreateNestedManyWithoutTreatingProviderInputSchema } from './LabOrderUncheckedCreateNestedManyWithoutTreatingProviderInputSchema';
...
export const ProviderUncheckedCreateWithoutOrderingProviderLabOrdersInputSchema: z.ZodType<Prisma.ProviderUncheckedCreateWithoutOrderingProviderLabOrdersInput> = z.strictObject({
  ...
  treatingProviderLabOrders: z.lazy(() => LabOrderUncheckedCreateNestedManyWithoutTreatingProviderInputSchema).optional(),
...
export default ProviderUncheckedCreateWithoutOrderingProviderLabOrdersInputSchema;
