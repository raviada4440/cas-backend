...
export const ConsentAuditLogCreateManyInputSchema: z.ZodType<Prisma.ConsentAuditLogCreateManyInput> = z.strictObject({
...
export default ConsentAuditLogCreateManyInputSchema;
