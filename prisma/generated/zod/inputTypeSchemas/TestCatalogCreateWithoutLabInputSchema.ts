...
export const TestCatalogCreateWithoutLabInputSchema: z.ZodType<Prisma.TestCatalogCreateWithoutLabInput> = z.strictObject({
...
export default TestCatalogCreateWithoutLabInputSchema;
