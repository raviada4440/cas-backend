...
export const TestCatalogVersionWhereInputSchema: z.ZodType<Prisma.TestCatalogVersionWhereInput> = z.strictObject({
...
export default TestCatalogVersionWhereInputSchema;
