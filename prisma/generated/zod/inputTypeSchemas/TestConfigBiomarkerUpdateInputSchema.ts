...
import { TestCatalogConfigurationUpdateOneRequiredWithoutBiomarkerOverridesNestedInputSchema } from './TestCatalogConfigurationUpdateOneRequiredWithoutBiomarkerOverridesNestedInputSchema';
import { BiomarkerUpdateOneRequiredWithoutConfigOverridesNestedInputSchema } from './BiomarkerUpdateOneRequiredWithoutConfigOverridesNestedInputSchema';

export const TestConfigBiomarkerUpdateInputSchema: z.ZodType<Prisma.TestConfigBiomarkerUpdateInput> = z.strictObject({
  ...
  configuration: z.lazy(() => TestCatalogConfigurationUpdateOneRequiredWithoutBiomarkerOverridesNestedInputSchema).optional(),
  biomarker: z.lazy(() => BiomarkerUpdateOneRequiredWithoutConfigOverridesNestedInputSchema).optional(),
});

export default TestConfigBiomarkerUpdateInputSchema;
