...
import { LabOrderUpdateOneWithoutLabOrderSpecimensNestedInputSchema } from './LabOrderUpdateOneWithoutLabOrderSpecimensNestedInputSchema';

export const LabOrderSpecimenUpdateInputSchema: z.ZodType<Prisma.LabOrderSpecimenUpdateInput> = z.strictObject({
  ...
  labOrder: z.lazy(() => LabOrderUpdateOneWithoutLabOrderSpecimensNestedInputSchema).optional(),
});

export default LabOrderSpecimenUpdateInputSchema;
