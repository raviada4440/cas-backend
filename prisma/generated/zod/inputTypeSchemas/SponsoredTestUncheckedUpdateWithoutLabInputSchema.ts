...
export const SponsoredTestUncheckedUpdateWithoutLabInputSchema: z.ZodType<Prisma.SponsoredTestUncheckedUpdateWithoutLabInput> = z.strictObject({
...
export default SponsoredTestUncheckedUpdateWithoutLabInputSchema;
