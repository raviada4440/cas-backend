...
export const LabOrderConsentCreateInputSchema: z.ZodType<Prisma.LabOrderConsentCreateInput> = z.strictObject({
...
export default LabOrderConsentCreateInputSchema;
