...
import { z } from 'zod';
import { TestCatalogVersionOrderLoincCreateNestedManyWithoutLoincInputSchema } from './TestCatalogVersionOrderLoincCreateNestedManyWithoutLoincInputSchema';
import { TestCatalogVersionResultLoincCreateNestedManyWithoutLoincInputSchema } from './TestCatalogVersionResultLoincCreateNestedManyWithoutLoincInputSchema';
import { TestConfigOrderLoincCreateNestedManyWithoutLoincInputSchema } from './TestConfigOrderLoincCreateNestedManyWithoutLoincInputSchema';
import { TestConfigResultLoincCreateNestedManyWithoutLoincInputSchema } from './TestConfigResultLoincCreateNestedManyWithoutLoincInputSchema';

export const LoincCreateInputSchema: z.ZodType<Prisma.LoincCreateInput> = z.strictObject({
  loincNum: z.string(),
  ...
  testOrderLoincs: z.lazy(() => TestCatalogVersionOrderLoincCreateNestedManyWithoutLoincInputSchema).optional(),
  testResultLoincs: z.lazy(() => TestCatalogVersionResultLoincCreateNestedManyWithoutLoincInputSchema).optional(),
  configOrderLoincs: z.lazy(() => TestConfigOrderLoincCreateNestedManyWithoutLoincInputSchema).optional(),
  configResultLoincs: z.lazy(() => TestConfigResultLoincCreateNestedManyWithoutLoincInputSchema).optional(),
});

export default LoincCreateInputSchema;
