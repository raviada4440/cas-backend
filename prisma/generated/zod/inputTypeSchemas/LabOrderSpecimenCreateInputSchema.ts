...
import { z } from 'zod';
import { LabOrderCreateNestedOneWithoutLabOrderSpecimensInputSchema } from './LabOrderCreateNestedOneWithoutLabOrderSpecimensInputSchema';

export const LabOrderSpecimenCreateInputSchema: z.ZodType<Prisma.LabOrderSpecimenCreateInput> = z.strictObject({
  ...
  labOrder: z.lazy(() => LabOrderCreateNestedOneWithoutLabOrderSpecimensInputSchema).optional(),
});

export default LabOrderSpecimenCreateInputSchema;
