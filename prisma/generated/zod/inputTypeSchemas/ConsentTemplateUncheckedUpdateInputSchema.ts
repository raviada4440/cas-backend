...
import { TestCatalogVersionConsentUncheckedUpdateManyWithoutConsentTemplateNestedInputSchema } from './TestCatalogVersionConsentUncheckedUpdateManyWithoutConsentTemplateNestedInputSchema';
import { LabOrderConsentUncheckedUpdateManyWithoutConsentTemplateNestedInputSchema } from './LabOrderConsentUncheckedUpdateManyWithoutConsentTemplateNestedInputSchema';
import { ConsentAuditLogUncheckedUpdateManyWithoutConsentTemplateNestedInputSchema } from './ConsentAuditLogUncheckedUpdateManyWithoutConsentTemplateNestedInputSchema';

export const ConsentTemplateUncheckedUpdateInputSchema: z.ZodType<Prisma.ConsentTemplateUncheckedUpdateInput> = z.strictObject({
  ...
  versionConsents: z.lazy(() => TestCatalogVersionConsentUncheckedUpdateManyWithoutConsentTemplateNestedInputSchema).optional(),
  labOrderConsents: z.lazy(() => LabOrderConsentUncheckedUpdateManyWithoutConsentTemplateNestedInputSchema).optional(),
  auditLogs: z.lazy(() => ConsentAuditLogUncheckedUpdateManyWithoutConsentTemplateNestedInputSchema).optional(),
});

export default ConsentTemplateUncheckedUpdateInputSchema;
