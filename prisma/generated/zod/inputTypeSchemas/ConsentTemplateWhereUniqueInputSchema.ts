...
import { z } from 'zod';
import { ConsentTemplateNameOrganizationIdCompoundUniqueInputSchema } from './ConsentTemplateNameOrganizationIdCompoundUniqueInputSchema';
...
export const ConsentTemplateWhereUniqueInputSchema: z.ZodType<Prisma.ConsentTemplateWhereUniqueInput> = z.union([
  z.object({
    id: z.string(),
    name_organizationId: z.lazy(() => ConsentTemplateNameOrganizationIdCompoundUniqueInputSchema),
  }),
  z.object({
    id: z.string(),
  }),
...
.and(z.strictObject({
  ...
  name_organizationId: z.lazy(() => ConsentTemplateNameOrganizationIdCompoundUniqueInputSchema).optional(),
...
export default ConsentTemplateWhereUniqueInputSchema;
