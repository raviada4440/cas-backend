...
export const SponsoredTestUncheckedCreateInputSchema: z.ZodType<Prisma.SponsoredTestUncheckedCreateInput> = z.strictObject({
...
export default SponsoredTestUncheckedCreateInputSchema;
