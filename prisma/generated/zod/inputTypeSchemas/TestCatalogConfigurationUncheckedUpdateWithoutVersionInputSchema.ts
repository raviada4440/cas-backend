...
import { TestCatalogVersionConsentUncheckedUpdateManyWithoutConfigurationNestedInputSchema } from './TestCatalogVersionConsentUncheckedUpdateManyWithoutConfigurationNestedInputSchema';
import { TestCatalogApprovalUncheckedUpdateManyWithoutConfigurationNestedInputSchema } from './TestCatalogApprovalUncheckedUpdateManyWithoutConfigurationNestedInputSchema';
import { LabOrderUncheckedUpdateManyWithoutConfigurationNestedInputSchema } from './LabOrderUncheckedUpdateManyWithoutConfigurationNestedInputSchema';
import { TestConfigCptCodeUncheckedUpdateManyWithoutConfigurationNestedInputSchema } from './TestConfigCptCodeUncheckedUpdateManyWithoutConfigurationNestedInputSchema';
import { TestConfigOrderLoincUncheckedUpdateManyWithoutConfigurationNestedInputSchema } from './TestConfigOrderLoincUncheckedUpdateManyWithoutConfigurationNestedInputSchema';
import { TestConfigResultLoincUncheckedUpdateManyWithoutConfigurationNestedInputSchema } from './TestConfigResultLoincUncheckedUpdateManyWithoutConfigurationNestedInputSchema';
import { TestConfigSpecimenManifestUncheckedUpdateManyWithoutConfigurationNestedInputSchema } from './TestConfigSpecimenManifestUncheckedUpdateManyWithoutConfigurationNestedInputSchema';
import { TestConfigBiomarkerUncheckedUpdateManyWithoutConfigurationNestedInputSchema } from './TestConfigBiomarkerUncheckedUpdateManyWithoutConfigurationNestedInputSchema';
import { TestCatalogVersionOrderFormUncheckedUpdateManyWithoutConfigurationNestedInputSchema } from './TestCatalogVersionOrderFormUncheckedUpdateManyWithoutConfigurationNestedInputSchema';

export const TestCatalogConfigurationUncheckedUpdateWithoutVersionInputSchema: z.ZodType<Prisma.TestCatalogConfigurationUncheckedUpdateWithoutVersionInput> = z.strictObject({
  ...
  consents: z.lazy(() => TestCatalogVersionConsentUncheckedUpdateManyWithoutConfigurationNestedInputSchema).optional(),
  approvals: z.lazy(() => TestCatalogApprovalUncheckedUpdateManyWithoutConfigurationNestedInputSchema).optional(),
  labOrders: z.lazy(() => LabOrderUncheckedUpdateManyWithoutConfigurationNestedInputSchema).optional(),
  cptOverrides: z.lazy(() => TestConfigCptCodeUncheckedUpdateManyWithoutConfigurationNestedInputSchema).optional(),
  orderLoincOverrides: z.lazy(() => TestConfigOrderLoincUncheckedUpdateManyWithoutConfigurationNestedInputSchema).optional(),
  resultLoincOverrides: z.lazy(() => TestConfigResultLoincUncheckedUpdateManyWithoutConfigurationNestedInputSchema).optional(),
  specimenManifestEntries: z.lazy(() => TestConfigSpecimenManifestUncheckedUpdateManyWithoutConfigurationNestedInputSchema).optional(),
  biomarkerOverrides: z.lazy(() => TestConfigBiomarkerUncheckedUpdateManyWithoutConfigurationNestedInputSchema).optional(),
  orderForms: z.lazy(() => TestCatalogVersionOrderFormUncheckedUpdateManyWithoutConfigurationNestedInputSchema).optional(),
});

export default TestCatalogConfigurationUncheckedUpdateWithoutVersionInputSchema;
