...
export const LabOrderBillingMaxOrderByAggregateInputSchema: z.ZodType<Prisma.LabOrderBillingMaxOrderByAggregateInput> = z.strictObject({
...
export default LabOrderBillingMaxOrderByAggregateInputSchema;
