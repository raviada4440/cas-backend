...
import { SponsoredTestUncheckedUpdateManyWithoutSponsoredProgramNestedInputSchema } from './SponsoredTestUncheckedUpdateManyWithoutSponsoredProgramNestedInputSchema';

export const SponsoredProgramUncheckedUpdateWithoutSponsorInputSchema: z.ZodType<Prisma.SponsoredProgramUncheckedUpdateWithoutSponsorInput> = z.strictObject({
  ...
  sponsoredTests: z.lazy(() => SponsoredTestUncheckedUpdateManyWithoutSponsoredProgramNestedInputSchema).optional(),
});

export default SponsoredProgramUncheckedUpdateWithoutSponsorInputSchema;
