...
export const LabOrderConsentUncheckedUpdateInputSchema: z.ZodType<Prisma.LabOrderConsentUncheckedUpdateInput> = z.strictObject({
...
export default LabOrderConsentUncheckedUpdateInputSchema;
