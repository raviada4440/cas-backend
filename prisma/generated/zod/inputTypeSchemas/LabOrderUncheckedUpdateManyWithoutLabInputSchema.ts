...
export const LabOrderUncheckedUpdateManyWithoutLabInputSchema: z.ZodType<Prisma.LabOrderUncheckedUpdateManyWithoutLabInput> = z.strictObject({
...
export default LabOrderUncheckedUpdateManyWithoutLabInputSchema;
