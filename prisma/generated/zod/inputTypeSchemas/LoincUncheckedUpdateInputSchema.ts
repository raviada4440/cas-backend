...
import { TestCatalogVersionOrderLoincUncheckedUpdateManyWithoutLoincNestedInputSchema } from './TestCatalogVersionOrderLoincUncheckedUpdateManyWithoutLoincNestedInputSchema';
import { TestCatalogVersionResultLoincUncheckedUpdateManyWithoutLoincNestedInputSchema } from './TestCatalogVersionResultLoincUncheckedUpdateManyWithoutLoincNestedInputSchema';
import { TestConfigOrderLoincUncheckedUpdateManyWithoutLoincNestedInputSchema } from './TestConfigOrderLoincUncheckedUpdateManyWithoutLoincNestedInputSchema';
import { TestConfigResultLoincUncheckedUpdateManyWithoutLoincNestedInputSchema } from './TestConfigResultLoincUncheckedUpdateManyWithoutLoincNestedInputSchema';

export const LoincUncheckedUpdateInputSchema: z.ZodType<Prisma.LoincUncheckedUpdateInput> = z.strictObject({
  ...
  testOrderLoincs: z.lazy(() => TestCatalogVersionOrderLoincUncheckedUpdateManyWithoutLoincNestedInputSchema).optional(),
  testResultLoincs: z.lazy(() => TestCatalogVersionResultLoincUncheckedUpdateManyWithoutLoincNestedInputSchema).optional(),
  configOrderLoincs: z.lazy(() => TestConfigOrderLoincUncheckedUpdateManyWithoutLoincNestedInputSchema).optional(),
  configResultLoincs: z.lazy(() => TestConfigResultLoincUncheckedUpdateManyWithoutLoincNestedInputSchema).optional(),
});

export default LoincUncheckedUpdateInputSchema;
