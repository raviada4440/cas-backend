...
export const LabOrderSpecimenMaxOrderByAggregateInputSchema: z.ZodType<Prisma.LabOrderSpecimenMaxOrderByAggregateInput> = z.strictObject({
...
export default LabOrderSpecimenMaxOrderByAggregateInputSchema;
