...
export const TestCatalogVersionSpecimenOrderByWithRelationInputSchema: z.ZodType<Prisma.TestCatalogVersionSpecimenOrderByWithRelationInput> = z.strictObject({
  ...
  variantManifests: z.lazy(() => TestConfigSpecimenManifestOrderByRelationAggregateInputSchema).optional(),
});

export default TestCatalogVersionSpecimenOrderByWithRelationInputSchema;
