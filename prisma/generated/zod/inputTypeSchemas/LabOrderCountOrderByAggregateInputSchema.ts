...
export const LabOrderCountOrderByAggregateInputSchema: z.ZodType<Prisma.LabOrderCountOrderByAggregateInput> = z.strictObject({
  ...
  riskFlags: z.lazy(() => SortOrderSchema).optional(),
  riskFlagNotes: z.lazy(() => SortOrderSchema).optional(),
  clinicalAttachments: z.lazy(() => SortOrderSchema).optional(),
...
export default LabOrderCountOrderByAggregateInputSchema;
