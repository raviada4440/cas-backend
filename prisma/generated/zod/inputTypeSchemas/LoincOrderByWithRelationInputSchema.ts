...
export const LoincOrderByWithRelationInputSchema: z.ZodType<Prisma.LoincOrderByWithRelationInput> = z.strictObject({
  ...
  testOrderLoincs: z.lazy(() => TestCatalogVersionOrderLoincOrderByRelationAggregateInputSchema).optional(),
  testResultLoincs: z.lazy(() => TestCatalogVersionResultLoincOrderByRelationAggregateInputSchema).optional(),
  configOrderLoincs: z.lazy(() => TestConfigOrderLoincOrderByRelationAggregateInputSchema).optional(),
  configResultLoincs: z.lazy(() => TestConfigResultLoincOrderByRelationAggregateInputSchema).optional(),
});

export default LoincOrderByWithRelationInputSchema;
