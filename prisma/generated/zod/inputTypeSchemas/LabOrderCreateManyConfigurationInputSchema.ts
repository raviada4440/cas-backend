...
export const LabOrderCreateManyConfigurationInputSchema: z.ZodType<Prisma.LabOrderCreateManyConfigurationInput> = z.strictObject({
...
export default LabOrderCreateManyConfigurationInputSchema;
