...
export const LabOrderSpecimenCreateManyInputSchema: z.ZodType<Prisma.LabOrderSpecimenCreateManyInput> = z.strictObject({
...
export default LabOrderSpecimenCreateManyInputSchema;
