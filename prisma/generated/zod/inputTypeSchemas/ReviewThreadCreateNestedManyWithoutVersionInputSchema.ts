...
export const ReviewThreadCreateNestedManyWithoutVersionInputSchema: z.ZodType<Prisma.ReviewThreadCreateNestedManyWithoutVersionInput> = z.strictObject({
...
export default ReviewThreadCreateNestedManyWithoutVersionInputSchema;
