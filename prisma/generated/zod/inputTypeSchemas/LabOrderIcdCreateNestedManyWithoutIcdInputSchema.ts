...
export const LabOrderIcdCreateNestedManyWithoutIcdInputSchema: z.ZodType<Prisma.LabOrderIcdCreateNestedManyWithoutIcdInput> = z.strictObject({
...
export default LabOrderIcdCreateNestedManyWithoutIcdInputSchema;
