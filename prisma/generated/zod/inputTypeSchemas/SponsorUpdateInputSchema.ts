...
import { SponsoredProgramUpdateManyWithoutSponsorNestedInputSchema } from './SponsoredProgramUpdateManyWithoutSponsorNestedInputSchema';

export const SponsorUpdateInputSchema: z.ZodType<Prisma.SponsorUpdateInput> = z.strictObject({
  ...
  sponsoredPrograms: z.lazy(() => SponsoredProgramUpdateManyWithoutSponsorNestedInputSchema).optional(),
});

export default SponsorUpdateInputSchema;
