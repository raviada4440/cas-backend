...
import { z } from 'zod';
import { TestCatalogVersionSpecimenVersionIdDisplayNameCompoundUniqueInputSchema } from './TestCatalogVersionSpecimenVersionIdDisplayNameCompoundUniqueInputSchema';
...
export const TestCatalogVersionSpecimenWhereUniqueInputSchema: z.ZodType<Prisma.TestCatalogVersionSpecimenWhereUniqueInput> = z.union([
  z.object({
    id: z.string(),
    versionId_displayName: z.lazy(() => TestCatalogVersionSpecimenVersionIdDisplayNameCompoundUniqueInputSchema),
  }),
  z.object({
    id: z.string(),
  }),
...
.and(z.strictObject({
  ...
  versionId_displayName: z.lazy(() => TestCatalogVersionSpecimenVersionIdDisplayNameCompoundUniqueInputSchema).optional(),
  AND: z.union([ z.lazy(() => TestCatalogVersionSpecimenWhereInputSchema), z.lazy(() => TestCatalogVersionSpecimenWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => TestCatalogVersionSpecimenWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => TestCatalogVersionSpecimenWhereInputSchema), z.lazy(() => TestCatalogVersionSpecimenWhereInputSchema).array() ]).optional(),
  ...
  variantManifests: z.lazy(() => TestConfigSpecimenManifestListRelationFilterSchema).optional(),
}));

export default TestCatalogVersionSpecimenWhereUniqueInputSchema;
