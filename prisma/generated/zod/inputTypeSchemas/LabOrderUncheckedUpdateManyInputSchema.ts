...
export const LabOrderUncheckedUpdateManyInputSchema: z.ZodType<Prisma.LabOrderUncheckedUpdateManyInput> = z.strictObject({
...
export default LabOrderUncheckedUpdateManyInputSchema;
