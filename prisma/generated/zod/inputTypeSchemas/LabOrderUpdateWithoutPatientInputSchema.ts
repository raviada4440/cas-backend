...
export const LabOrderUpdateWithoutPatientInputSchema: z.ZodType<Prisma.LabOrderUpdateWithoutPatientInput> = z.strictObject({
...
export default LabOrderUpdateWithoutPatientInputSchema;
