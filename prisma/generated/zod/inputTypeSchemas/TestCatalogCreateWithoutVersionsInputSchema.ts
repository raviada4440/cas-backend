...
export const TestCatalogCreateWithoutVersionsInputSchema: z.ZodType<Prisma.TestCatalogCreateWithoutVersionsInput> = z.strictObject({
...
export default TestCatalogCreateWithoutVersionsInputSchema;
