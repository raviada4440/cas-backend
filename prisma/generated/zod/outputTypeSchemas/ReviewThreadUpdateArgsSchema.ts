...
export const ReviewThreadUpdateArgsSchema: z.ZodType<Prisma.ReviewThreadUpdateArgs> = z.object({
  select: ReviewThreadSelectSchema.optional(),
  include: z.lazy(() => ReviewThreadIncludeSchema).optional(),
  data: z.union([ ReviewThreadUpdateInputSchema, ReviewThreadUncheckedUpdateInputSchema ]),
  where: ReviewThreadWhereUniqueInputSchema, 
}).strict();

export default ReviewThreadUpdateArgsSchema;
