...
import { ConsentAuditLogUpdateInputSchema } from '../inputTypeSchemas/ConsentAuditLogUpdateInputSchema'
import { ConsentAuditLogUncheckedUpdateInputSchema } from '../inputTypeSchemas/ConsentAuditLogUncheckedUpdateInputSchema'
...
export const ConsentAuditLogUpsertArgsSchema: z.ZodType<Prisma.ConsentAuditLogUpsertArgs> = z.object({
  ...
  create: z.union([ ConsentAuditLogCreateInputSchema, ConsentAuditLogUncheckedCreateInputSchema ]),
  update: z.union([ ConsentAuditLogUpdateInputSchema, ConsentAuditLogUncheckedUpdateInputSchema ]),
}).strict();

export default ConsentAuditLogUpsertArgsSchema;
