...
export const TestCatalogAuditLogCreateArgsSchema: z.ZodType<Prisma.TestCatalogAuditLogCreateArgs> = z.object({
  select: TestCatalogAuditLogSelectSchema.optional(),
  include: z.lazy(() => TestCatalogAuditLogIncludeSchema).optional(),
  data: z.union([ TestCatalogAuditLogCreateInputSchema, TestCatalogAuditLogUncheckedCreateInputSchema ]),
}).strict();

export default TestCatalogAuditLogCreateArgsSchema;
