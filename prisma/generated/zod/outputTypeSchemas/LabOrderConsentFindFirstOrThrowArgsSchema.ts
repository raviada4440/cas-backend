...
export const LabOrderConsentFindFirstOrThrowArgsSchema: z.ZodType<Prisma.LabOrderConsentFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ LabOrderConsentScalarFieldEnumSchema, LabOrderConsentScalarFieldEnumSchema.array() ]).optional(),
}).strict();

export default LabOrderConsentFindFirstOrThrowArgsSchema;
