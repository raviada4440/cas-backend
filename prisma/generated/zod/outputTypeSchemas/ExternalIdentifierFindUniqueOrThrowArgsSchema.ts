...
export const ExternalIdentifierFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.ExternalIdentifierFindUniqueOrThrowArgs> = z.object({
  select: ExternalIdentifierSelectSchema.optional(),
  where: ExternalIdentifierWhereUniqueInputSchema, 
}).strict();

export default ExternalIdentifierFindUniqueOrThrowArgsSchema;
