...
export const LabOrderFormUpdateArgsSchema: z.ZodType<Prisma.LabOrderFormUpdateArgs> = z.object({
  select: LabOrderFormSelectSchema.optional(),
  include: z.lazy(() => LabOrderFormIncludeSchema).optional(),
  data: z.union([ LabOrderFormUpdateInputSchema, LabOrderFormUncheckedUpdateInputSchema ]),
  where: LabOrderFormWhereUniqueInputSchema, 
}).strict();

export default LabOrderFormUpdateArgsSchema;
