...
export const TestCatalogVersionResultLoincUpdateArgsSchema: z.ZodType<Prisma.TestCatalogVersionResultLoincUpdateArgs> = z.object({
  ...
  data: z.union([ TestCatalogVersionResultLoincUpdateInputSchema, TestCatalogVersionResultLoincUncheckedUpdateInputSchema ]),
  where: TestCatalogVersionResultLoincWhereUniqueInputSchema, 
}).strict();

export default TestCatalogVersionResultLoincUpdateArgsSchema;
