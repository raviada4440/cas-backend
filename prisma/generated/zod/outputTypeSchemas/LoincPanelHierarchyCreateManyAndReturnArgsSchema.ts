...
export const LoincPanelHierarchyCreateManyAndReturnArgsSchema: z.ZodType<Prisma.LoincPanelHierarchyCreateManyAndReturnArgs> = z.object({
  data: z.union([ LoincPanelHierarchyCreateManyInputSchema, LoincPanelHierarchyCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict();

export default LoincPanelHierarchyCreateManyAndReturnArgsSchema;
