...
export const OrderFormTemplateCreateArgsSchema: z.ZodType<Prisma.OrderFormTemplateCreateArgs> = z.object({
  select: OrderFormTemplateSelectSchema.optional(),
  include: z.lazy(() => OrderFormTemplateIncludeSchema).optional(),
  data: z.union([ OrderFormTemplateCreateInputSchema, OrderFormTemplateUncheckedCreateInputSchema ]),
}).strict();

export default OrderFormTemplateCreateArgsSchema;
