...
export const LoincCreateManyAndReturnArgsSchema: z.ZodType<Prisma.LoincCreateManyAndReturnArgs> = z.object({
  data: z.union([ LoincCreateManyInputSchema, LoincCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict();

export default LoincCreateManyAndReturnArgsSchema;
