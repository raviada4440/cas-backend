...
export const TestCatalogVersionSpecimenUpdateArgsSchema: z.ZodType<Prisma.TestCatalogVersionSpecimenUpdateArgs> = z.object({
  select: TestCatalogVersionSpecimenSelectSchema.optional(),
  include: z.lazy(() => TestCatalogVersionSpecimenIncludeSchema).optional(),
  data: z.union([ TestCatalogVersionSpecimenUpdateInputSchema, TestCatalogVersionSpecimenUncheckedUpdateInputSchema ]),
  where: TestCatalogVersionSpecimenWhereUniqueInputSchema, 
}).strict();

export default TestCatalogVersionSpecimenUpdateArgsSchema;
