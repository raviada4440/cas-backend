...
export const ConsentTemplateCreateArgsSchema: z.ZodType<Prisma.ConsentTemplateCreateArgs> = z.object({
  select: ConsentTemplateSelectSchema.optional(),
  include: z.lazy(() => ConsentTemplateIncludeSchema).optional(),
  data: z.union([ ConsentTemplateCreateInputSchema, ConsentTemplateUncheckedCreateInputSchema ]),
}).strict();

export default ConsentTemplateCreateArgsSchema;
