...
export const OrganizationFavoriteTestCreateArgsSchema: z.ZodType<Prisma.OrganizationFavoriteTestCreateArgs> = z.object({
  ...
  data: z.union([ OrganizationFavoriteTestCreateInputSchema, OrganizationFavoriteTestUncheckedCreateInputSchema ]),
}).strict();

export default OrganizationFavoriteTestCreateArgsSchema;
