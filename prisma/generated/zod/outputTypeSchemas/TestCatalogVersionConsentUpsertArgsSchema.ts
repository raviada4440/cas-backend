...
import { TestCatalogVersionConsentCreateInputSchema } from '../inputTypeSchemas/TestCatalogVersionConsentCreateInputSchema'
import { TestCatalogVersionConsentUncheckedCreateInputSchema } from '../inputTypeSchemas/TestCatalogVersionConsentUncheckedCreateInputSchema'
import { TestCatalogVersionConsentUpdateInputSchema } from '../inputTypeSchemas/TestCatalogVersionConsentUpdateInputSchema'
import { TestCatalogVersionConsentUncheckedUpdateInputSchema } from '../inputTypeSchemas/TestCatalogVersionConsentUncheckedUpdateInputSchema'
...
export const TestCatalogVersionConsentUpsertArgsSchema: z.ZodType<Prisma.TestCatalogVersionConsentUpsertArgs> = z.object({
  select: TestCatalogVersionConsentSelectSchema.optional(),
  include: z.lazy(() => TestCatalogVersionConsentIncludeSchema).optional(),
  where: TestCatalogVersionConsentWhereUniqueInputSchema, 
  create: z.union([ TestCatalogVersionConsentCreateInputSchema, TestCatalogVersionConsentUncheckedCreateInputSchema ]),
  update: z.union([ TestCatalogVersionConsentUpdateInputSchema, TestCatalogVersionConsentUncheckedUpdateInputSchema ]),
}).strict();

export default TestCatalogVersionConsentUpsertArgsSchema;
