...
export const TestConfigSpecimenManifestCreateArgsSchema: z.ZodType<Prisma.TestConfigSpecimenManifestCreateArgs> = z.object({
  select: TestConfigSpecimenManifestSelectSchema.optional(),
  include: z.lazy(() => TestConfigSpecimenManifestIncludeSchema).optional(),
  data: z.union([ TestConfigSpecimenManifestCreateInputSchema, TestConfigSpecimenManifestUncheckedCreateInputSchema ]),
}).strict();

export default TestConfigSpecimenManifestCreateArgsSchema;
