...
export const LabOrderSponsoredTestConsentCreateArgsSchema: z.ZodType<Prisma.LabOrderSponsoredTestConsentCreateArgs> = z.object({
  ...
  data: z.union([ LabOrderSponsoredTestConsentCreateInputSchema, LabOrderSponsoredTestConsentUncheckedCreateInputSchema ]),
}).strict();

export default LabOrderSponsoredTestConsentCreateArgsSchema;
