...
export const ConsentAuditLogUpdateArgsSchema: z.ZodType<Prisma.ConsentAuditLogUpdateArgs> = z.object({
  select: ConsentAuditLogSelectSchema.optional(),
  include: z.lazy(() => ConsentAuditLogIncludeSchema).optional(),
  data: z.union([ ConsentAuditLogUpdateInputSchema, ConsentAuditLogUncheckedUpdateInputSchema ]),
  where: ConsentAuditLogWhereUniqueInputSchema, 
}).strict();

export default ConsentAuditLogUpdateArgsSchema;
