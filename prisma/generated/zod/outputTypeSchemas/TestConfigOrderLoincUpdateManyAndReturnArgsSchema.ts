...
export const TestConfigOrderLoincUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.TestConfigOrderLoincUpdateManyAndReturnArgs> = z.object({
...
export default TestConfigOrderLoincUpdateManyAndReturnArgsSchema;
