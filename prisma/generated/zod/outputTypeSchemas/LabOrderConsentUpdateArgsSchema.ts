...
export const LabOrderConsentUpdateArgsSchema: z.ZodType<Prisma.LabOrderConsentUpdateArgs> = z.object({
  select: LabOrderConsentSelectSchema.optional(),
  include: z.lazy(() => LabOrderConsentIncludeSchema).optional(),
  data: z.union([ LabOrderConsentUpdateInputSchema, LabOrderConsentUncheckedUpdateInputSchema ]),
  where: LabOrderConsentWhereUniqueInputSchema, 
}).strict();

export default LabOrderConsentUpdateArgsSchema;
