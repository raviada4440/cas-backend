...
export const TestConfigSpecimenManifestUpdateArgsSchema: z.ZodType<Prisma.TestConfigSpecimenManifestUpdateArgs> = z.object({
  select: TestConfigSpecimenManifestSelectSchema.optional(),
  include: z.lazy(() => TestConfigSpecimenManifestIncludeSchema).optional(),
  data: z.union([ TestConfigSpecimenManifestUpdateInputSchema, TestConfigSpecimenManifestUncheckedUpdateInputSchema ]),
  where: TestConfigSpecimenManifestWhereUniqueInputSchema, 
}).strict();

export default TestConfigSpecimenManifestUpdateArgsSchema;
