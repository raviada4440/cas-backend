...
export const OrderFormSectionCreateArgsSchema: z.ZodType<Prisma.OrderFormSectionCreateArgs> = z.object({
  select: OrderFormSectionSelectSchema.optional(),
  include: z.lazy(() => OrderFormSectionIncludeSchema).optional(),
  data: z.union([ OrderFormSectionCreateInputSchema, OrderFormSectionUncheckedCreateInputSchema ]),
}).strict();

export default OrderFormSectionCreateArgsSchema;
