...
export const TestCatalogVersionCreateManyAndReturnArgsSchema: z.ZodType<Prisma.TestCatalogVersionCreateManyAndReturnArgs> = z.object({
  data: z.union([ TestCatalogVersionCreateManyInputSchema, TestCatalogVersionCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict();

export default TestCatalogVersionCreateManyAndReturnArgsSchema;
