...
import { LabOrderConsentCreateInputSchema } from '../inputTypeSchemas/LabOrderConsentCreateInputSchema'
import { LabOrderConsentUncheckedCreateInputSchema } from '../inputTypeSchemas/LabOrderConsentUncheckedCreateInputSchema'
import { LabOrderConsentUpdateInputSchema } from '../inputTypeSchemas/LabOrderConsentUpdateInputSchema'
import { LabOrderConsentUncheckedUpdateInputSchema } from '../inputTypeSchemas/LabOrderConsentUncheckedUpdateInputSchema'
...
export const LabOrderConsentUpsertArgsSchema: z.ZodType<Prisma.LabOrderConsentUpsertArgs> = z.object({
  ...
  create: z.union([ LabOrderConsentCreateInputSchema, LabOrderConsentUncheckedCreateInputSchema ]),
  update: z.union([ LabOrderConsentUpdateInputSchema, LabOrderConsentUncheckedUpdateInputSchema ]),
}).strict();

export default LabOrderConsentUpsertArgsSchema;
