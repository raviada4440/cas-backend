...
export const TestConfigResultLoincUpdateArgsSchema: z.ZodType<Prisma.TestConfigResultLoincUpdateArgs> = z.object({
  select: TestConfigResultLoincSelectSchema.optional(),
  include: z.lazy(() => TestConfigResultLoincIncludeSchema).optional(),
  data: z.union([ TestConfigResultLoincUpdateInputSchema, TestConfigResultLoincUncheckedUpdateInputSchema ]),
  where: TestConfigResultLoincWhereUniqueInputSchema, 
}).strict();

export default TestConfigResultLoincUpdateArgsSchema;
