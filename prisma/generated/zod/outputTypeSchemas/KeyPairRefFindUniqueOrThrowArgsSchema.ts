...
export const KeyPairRefFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.KeyPairRefFindUniqueOrThrowArgs> = z.object({
  select: KeyPairRefSelectSchema.optional(),
  where: KeyPairRefWhereUniqueInputSchema, 
}).strict();

export default KeyPairRefFindUniqueOrThrowArgsSchema;
