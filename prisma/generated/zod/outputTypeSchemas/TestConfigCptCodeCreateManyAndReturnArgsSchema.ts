...
export const TestConfigCptCodeCreateManyAndReturnArgsSchema: z.ZodType<Prisma.TestConfigCptCodeCreateManyAndReturnArgs> = z.object({
  data: z.union([ TestConfigCptCodeCreateManyInputSchema, TestConfigCptCodeCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict();

export default TestConfigCptCodeCreateManyAndReturnArgsSchema;
