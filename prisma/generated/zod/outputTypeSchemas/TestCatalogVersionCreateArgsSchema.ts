...
export const TestCatalogVersionCreateArgsSchema: z.ZodType<Prisma.TestCatalogVersionCreateArgs> = z.object({
  select: TestCatalogVersionSelectSchema.optional(),
  include: z.lazy(() => TestCatalogVersionIncludeSchema).optional(),
  data: z.union([ TestCatalogVersionCreateInputSchema, TestCatalogVersionUncheckedCreateInputSchema ]),
}).strict();

export default TestCatalogVersionCreateArgsSchema;
