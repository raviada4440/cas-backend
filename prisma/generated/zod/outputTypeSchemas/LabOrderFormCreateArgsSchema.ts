...
export const LabOrderFormCreateArgsSchema: z.ZodType<Prisma.LabOrderFormCreateArgs> = z.object({
  select: LabOrderFormSelectSchema.optional(),
  include: z.lazy(() => LabOrderFormIncludeSchema).optional(),
  data: z.union([ LabOrderFormCreateInputSchema, LabOrderFormUncheckedCreateInputSchema ]),
}).strict();

export default LabOrderFormCreateArgsSchema;
