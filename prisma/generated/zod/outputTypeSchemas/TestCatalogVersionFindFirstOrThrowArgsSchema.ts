...
export const TestCatalogVersionFindFirstOrThrowArgsSchema: z.ZodType<Prisma.TestCatalogVersionFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ TestCatalogVersionScalarFieldEnumSchema, TestCatalogVersionScalarFieldEnumSchema.array() ]).optional(),
}).strict();

export default TestCatalogVersionFindFirstOrThrowArgsSchema;
