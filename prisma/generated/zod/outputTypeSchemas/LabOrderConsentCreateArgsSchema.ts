...
export const LabOrderConsentCreateArgsSchema: z.ZodType<Prisma.LabOrderConsentCreateArgs> = z.object({
  select: LabOrderConsentSelectSchema.optional(),
  include: z.lazy(() => LabOrderConsentIncludeSchema).optional(),
  data: z.union([ LabOrderConsentCreateInputSchema, LabOrderConsentUncheckedCreateInputSchema ]),
}).strict();

export default LabOrderConsentCreateArgsSchema;
