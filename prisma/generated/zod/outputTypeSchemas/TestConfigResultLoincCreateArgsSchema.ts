...
export const TestConfigResultLoincCreateArgsSchema: z.ZodType<Prisma.TestConfigResultLoincCreateArgs> = z.object({
  select: TestConfigResultLoincSelectSchema.optional(),
  include: z.lazy(() => TestConfigResultLoincIncludeSchema).optional(),
  data: z.union([ TestConfigResultLoincCreateInputSchema, TestConfigResultLoincUncheckedCreateInputSchema ]),
}).strict();

export default TestConfigResultLoincCreateArgsSchema;
