...
import { TestCatalogConfigurationUpdateInputSchema } from '../inputTypeSchemas/TestCatalogConfigurationUpdateInputSchema'
import { TestCatalogConfigurationUncheckedUpdateInputSchema } from '../inputTypeSchemas/TestCatalogConfigurationUncheckedUpdateInputSchema'
...
export const TestCatalogConfigurationUpsertArgsSchema: z.ZodType<Prisma.TestCatalogConfigurationUpsertArgs> = z.object({
  select: TestCatalogConfigurationSelectSchema.optional(),
  include: z.lazy(() => TestCatalogConfigurationIncludeSchema).optional(),
  where: TestCatalogConfigurationWhereUniqueInputSchema, 
  create: z.union([ TestCatalogConfigurationCreateInputSchema, TestCatalogConfigurationUncheckedCreateInputSchema ]),
  update: z.union([ TestCatalogConfigurationUpdateInputSchema, TestCatalogConfigurationUncheckedUpdateInputSchema ]),
}).strict();

export default TestCatalogConfigurationUpsertArgsSchema;
