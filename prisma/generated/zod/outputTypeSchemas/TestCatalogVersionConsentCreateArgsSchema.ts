...
export const TestCatalogVersionConsentCreateArgsSchema: z.ZodType<Prisma.TestCatalogVersionConsentCreateArgs> = z.object({
  select: TestCatalogVersionConsentSelectSchema.optional(),
  include: z.lazy(() => TestCatalogVersionConsentIncludeSchema).optional(),
  data: z.union([ TestCatalogVersionConsentCreateInputSchema, TestCatalogVersionConsentUncheckedCreateInputSchema ]),
}).strict();

export default TestCatalogVersionConsentCreateArgsSchema;
