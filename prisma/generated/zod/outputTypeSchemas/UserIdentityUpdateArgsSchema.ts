...
export const UserIdentityUpdateArgsSchema: z.ZodType<Prisma.UserIdentityUpdateArgs> = z.object({
  select: UserIdentitySelectSchema.optional(),
  include: z.lazy(() => UserIdentityIncludeSchema).optional(),
  data: z.union([ UserIdentityUpdateInputSchema, UserIdentityUncheckedUpdateInputSchema ]),
  where: UserIdentityWhereUniqueInputSchema, 
}).strict();

export default UserIdentityUpdateArgsSchema;
