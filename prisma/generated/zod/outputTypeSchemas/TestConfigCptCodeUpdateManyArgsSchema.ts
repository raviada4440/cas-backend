...
export const TestConfigCptCodeUpdateManyArgsSchema: z.ZodType<Prisma.TestConfigCptCodeUpdateManyArgs> = z.object({
...
export default TestConfigCptCodeUpdateManyArgsSchema;
