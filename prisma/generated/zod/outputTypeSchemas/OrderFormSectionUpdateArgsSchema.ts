...
export const OrderFormSectionUpdateArgsSchema: z.ZodType<Prisma.OrderFormSectionUpdateArgs> = z.object({
  select: OrderFormSectionSelectSchema.optional(),
  include: z.lazy(() => OrderFormSectionIncludeSchema).optional(),
  data: z.union([ OrderFormSectionUpdateInputSchema, OrderFormSectionUncheckedUpdateInputSchema ]),
  where: OrderFormSectionWhereUniqueInputSchema, 
}).strict();

export default OrderFormSectionUpdateArgsSchema;
