...
export const TestCatalogVersionOrderLoincUpdateArgsSchema: z.ZodType<Prisma.TestCatalogVersionOrderLoincUpdateArgs> = z.object({
  ...
  data: z.union([ TestCatalogVersionOrderLoincUpdateInputSchema, TestCatalogVersionOrderLoincUncheckedUpdateInputSchema ]),
  where: TestCatalogVersionOrderLoincWhereUniqueInputSchema, 
}).strict();

export default TestCatalogVersionOrderLoincUpdateArgsSchema;
