...
export const ConsentTemplateUpdateArgsSchema: z.ZodType<Prisma.ConsentTemplateUpdateArgs> = z.object({
  select: ConsentTemplateSelectSchema.optional(),
  include: z.lazy(() => ConsentTemplateIncludeSchema).optional(),
  data: z.union([ ConsentTemplateUpdateInputSchema, ConsentTemplateUncheckedUpdateInputSchema ]),
  where: ConsentTemplateWhereUniqueInputSchema, 
}).strict();

export default ConsentTemplateUpdateArgsSchema;
