...
export const TestConfigCptCodeUpdateArgsSchema: z.ZodType<Prisma.TestConfigCptCodeUpdateArgs> = z.object({
  select: TestConfigCptCodeSelectSchema.optional(),
  include: z.lazy(() => TestConfigCptCodeIncludeSchema).optional(),
  data: z.union([ TestConfigCptCodeUpdateInputSchema, TestConfigCptCodeUncheckedUpdateInputSchema ]),
  where: TestConfigCptCodeWhereUniqueInputSchema, 
}).strict();

export default TestConfigCptCodeUpdateArgsSchema;
