...
export const TestCatalogConfigurationFindFirstOrThrowArgsSchema: z.ZodType<Prisma.TestCatalogConfigurationFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ TestCatalogConfigurationScalarFieldEnumSchema, TestCatalogConfigurationScalarFieldEnumSchema.array() ]).optional(),
}).strict();

export default TestCatalogConfigurationFindFirstOrThrowArgsSchema;
