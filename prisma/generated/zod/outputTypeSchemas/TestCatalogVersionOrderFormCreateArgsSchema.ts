...
export const TestCatalogVersionOrderFormCreateArgsSchema: z.ZodType<Prisma.TestCatalogVersionOrderFormCreateArgs> = z.object({
  select: TestCatalogVersionOrderFormSelectSchema.optional(),
  include: z.lazy(() => TestCatalogVersionOrderFormIncludeSchema).optional(),
  data: z.union([ TestCatalogVersionOrderFormCreateInputSchema, TestCatalogVersionOrderFormUncheckedCreateInputSchema ]),
}).strict();

export default TestCatalogVersionOrderFormCreateArgsSchema;
