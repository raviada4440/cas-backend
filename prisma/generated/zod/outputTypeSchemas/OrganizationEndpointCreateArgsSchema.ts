...
import { OrganizationEndpointCreateInputSchema } from '../inputTypeSchemas/OrganizationEndpointCreateInputSchema'
import { OrganizationEndpointUncheckedCreateInputSchema } from '../inputTypeSchemas/OrganizationEndpointUncheckedCreateInputSchema'
...
export const OrganizationEndpointCreateArgsSchema: z.ZodType<Prisma.OrganizationEndpointCreateArgs> = z.object({
  ...
  data: z.union([ OrganizationEndpointCreateInputSchema, OrganizationEndpointUncheckedCreateInputSchema ]),
}).strict();

export default OrganizationEndpointCreateArgsSchema;
