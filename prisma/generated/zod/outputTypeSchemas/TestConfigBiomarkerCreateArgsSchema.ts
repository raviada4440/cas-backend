...
export const TestConfigBiomarkerCreateArgsSchema: z.ZodType<Prisma.TestConfigBiomarkerCreateArgs> = z.object({
  select: TestConfigBiomarkerSelectSchema.optional(),
  include: z.lazy(() => TestConfigBiomarkerIncludeSchema).optional(),
  data: z.union([ TestConfigBiomarkerCreateInputSchema, TestConfigBiomarkerUncheckedCreateInputSchema ]),
}).strict();

export default TestConfigBiomarkerCreateArgsSchema;
