...
export const TestCatalogAuditLogUpdateArgsSchema: z.ZodType<Prisma.TestCatalogAuditLogUpdateArgs> = z.object({
  select: TestCatalogAuditLogSelectSchema.optional(),
  include: z.lazy(() => TestCatalogAuditLogIncludeSchema).optional(),
  data: z.union([ TestCatalogAuditLogUpdateInputSchema, TestCatalogAuditLogUncheckedUpdateInputSchema ]),
  where: TestCatalogAuditLogWhereUniqueInputSchema, 
}).strict();

export default TestCatalogAuditLogUpdateArgsSchema;
