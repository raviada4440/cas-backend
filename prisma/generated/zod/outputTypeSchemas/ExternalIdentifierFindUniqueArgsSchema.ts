...
export const ExternalIdentifierFindUniqueArgsSchema: z.ZodType<Prisma.ExternalIdentifierFindUniqueArgs> = z.object({
  select: ExternalIdentifierSelectSchema.optional(),
  where: ExternalIdentifierWhereUniqueInputSchema, 
}).strict();

export default ExternalIdentifierFindUniqueArgsSchema;
