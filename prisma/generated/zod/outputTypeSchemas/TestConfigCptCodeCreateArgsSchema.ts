...
export const TestConfigCptCodeCreateArgsSchema: z.ZodType<Prisma.TestConfigCptCodeCreateArgs> = z.object({
  select: TestConfigCptCodeSelectSchema.optional(),
  include: z.lazy(() => TestConfigCptCodeIncludeSchema).optional(),
  data: z.union([ TestConfigCptCodeCreateInputSchema, TestConfigCptCodeUncheckedCreateInputSchema ]),
}).strict();

export default TestConfigCptCodeCreateArgsSchema;
