...
export const TestCatalogVersionCptCodeUpdateArgsSchema: z.ZodType<Prisma.TestCatalogVersionCptCodeUpdateArgs> = z.object({
  select: TestCatalogVersionCptCodeSelectSchema.optional(),
  include: z.lazy(() => TestCatalogVersionCptCodeIncludeSchema).optional(),
  data: z.union([ TestCatalogVersionCptCodeUpdateInputSchema, TestCatalogVersionCptCodeUncheckedUpdateInputSchema ]),
  where: TestCatalogVersionCptCodeWhereUniqueInputSchema, 
}).strict();

export default TestCatalogVersionCptCodeUpdateArgsSchema;
