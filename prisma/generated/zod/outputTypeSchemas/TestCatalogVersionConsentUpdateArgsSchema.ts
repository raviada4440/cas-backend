...
export const TestCatalogVersionConsentUpdateArgsSchema: z.ZodType<Prisma.TestCatalogVersionConsentUpdateArgs> = z.object({
  select: TestCatalogVersionConsentSelectSchema.optional(),
  include: z.lazy(() => TestCatalogVersionConsentIncludeSchema).optional(),
  data: z.union([ TestCatalogVersionConsentUpdateInputSchema, TestCatalogVersionConsentUncheckedUpdateInputSchema ]),
  where: TestCatalogVersionConsentWhereUniqueInputSchema, 
}).strict();

export default TestCatalogVersionConsentUpdateArgsSchema;
