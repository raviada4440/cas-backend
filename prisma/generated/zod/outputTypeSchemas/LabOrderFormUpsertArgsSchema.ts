...
import { LabOrderFormCreateInputSchema } from '../inputTypeSchemas/LabOrderFormCreateInputSchema'
import { LabOrderFormUncheckedCreateInputSchema } from '../inputTypeSchemas/LabOrderFormUncheckedCreateInputSchema'
import { LabOrderFormUpdateInputSchema } from '../inputTypeSchemas/LabOrderFormUpdateInputSchema'
import { LabOrderFormUncheckedUpdateInputSchema } from '../inputTypeSchemas/LabOrderFormUncheckedUpdateInputSchema'
...
export const LabOrderFormUpsertArgsSchema: z.ZodType<Prisma.LabOrderFormUpsertArgs> = z.object({
  ...
  create: z.union([ LabOrderFormCreateInputSchema, LabOrderFormUncheckedCreateInputSchema ]),
  update: z.union([ LabOrderFormUpdateInputSchema, LabOrderFormUncheckedUpdateInputSchema ]),
}).strict();

export default LabOrderFormUpsertArgsSchema;
