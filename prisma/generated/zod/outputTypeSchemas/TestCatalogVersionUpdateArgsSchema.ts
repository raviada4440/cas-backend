...
export const TestCatalogVersionUpdateArgsSchema: z.ZodType<Prisma.TestCatalogVersionUpdateArgs> = z.object({
  select: TestCatalogVersionSelectSchema.optional(),
  include: z.lazy(() => TestCatalogVersionIncludeSchema).optional(),
  data: z.union([ TestCatalogVersionUpdateInputSchema, TestCatalogVersionUncheckedUpdateInputSchema ]),
  where: TestCatalogVersionWhereUniqueInputSchema, 
}).strict();

export default TestCatalogVersionUpdateArgsSchema;
