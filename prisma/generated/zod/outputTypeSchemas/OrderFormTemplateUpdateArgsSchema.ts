...
export const OrderFormTemplateUpdateArgsSchema: z.ZodType<Prisma.OrderFormTemplateUpdateArgs> = z.object({
  select: OrderFormTemplateSelectSchema.optional(),
  include: z.lazy(() => OrderFormTemplateIncludeSchema).optional(),
  data: z.union([ OrderFormTemplateUpdateInputSchema, OrderFormTemplateUncheckedUpdateInputSchema ]),
  where: OrderFormTemplateWhereUniqueInputSchema, 
}).strict();

export default OrderFormTemplateUpdateArgsSchema;
