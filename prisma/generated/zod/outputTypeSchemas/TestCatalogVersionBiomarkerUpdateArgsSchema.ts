...
export const TestCatalogVersionBiomarkerUpdateArgsSchema: z.ZodType<Prisma.TestCatalogVersionBiomarkerUpdateArgs> = z.object({
  select: TestCatalogVersionBiomarkerSelectSchema.optional(),
  include: z.lazy(() => TestCatalogVersionBiomarkerIncludeSchema).optional(),
  data: z.union([ TestCatalogVersionBiomarkerUpdateInputSchema, TestCatalogVersionBiomarkerUncheckedUpdateInputSchema ]),
  where: TestCatalogVersionBiomarkerWhereUniqueInputSchema, 
}).strict();

export default TestCatalogVersionBiomarkerUpdateArgsSchema;
