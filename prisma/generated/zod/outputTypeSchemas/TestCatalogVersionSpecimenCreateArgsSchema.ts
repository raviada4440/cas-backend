...
export const TestCatalogVersionSpecimenCreateArgsSchema: z.ZodType<Prisma.TestCatalogVersionSpecimenCreateArgs> = z.object({
  select: TestCatalogVersionSpecimenSelectSchema.optional(),
  include: z.lazy(() => TestCatalogVersionSpecimenIncludeSchema).optional(),
  data: z.union([ TestCatalogVersionSpecimenCreateInputSchema, TestCatalogVersionSpecimenUncheckedCreateInputSchema ]),
}).strict();

export default TestCatalogVersionSpecimenCreateArgsSchema;
