...
export const TestCatalogApprovalCreateManyArgsSchema: z.ZodType<Prisma.TestCatalogApprovalCreateManyArgs> = z.object({
  data: z.union([ TestCatalogApprovalCreateManyInputSchema, TestCatalogApprovalCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict();

export default TestCatalogApprovalCreateManyArgsSchema;
