...
export const TestCatalogConfigurationUpdateArgsSchema: z.ZodType<Prisma.TestCatalogConfigurationUpdateArgs> = z.object({
  select: TestCatalogConfigurationSelectSchema.optional(),
  include: z.lazy(() => TestCatalogConfigurationIncludeSchema).optional(),
  data: z.union([ TestCatalogConfigurationUpdateInputSchema, TestCatalogConfigurationUncheckedUpdateInputSchema ]),
  where: TestCatalogConfigurationWhereUniqueInputSchema, 
}).strict();

export default TestCatalogConfigurationUpdateArgsSchema;
